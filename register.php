				...
				<div class="container-fluid">
					<form method="post" action="">
						...
						<div class="mb-3">
							...
							<input name="Full Name" id="fullName" type="text" class="form-control rounded-0" placeholder="User Name" autofocus="" value="<?= isset($_POST['Full Name']) ? $_POST['Full Name'] : '' ?>" required>
                        ...
                        <div class="mb-3">
							...
							<input type="Re-enter password" class="form-control rounded-0" id="reEnterPassword" name="pwd" placeholder="Re-enter Password" required>
							<div id="reEnteredPasswordError"></div>
						</div>
					...
					<button type="submit" name="user_register" id="register" class="btn btn-primary"><span class="fa fa-user"></span>&nbsp;Register</button>
