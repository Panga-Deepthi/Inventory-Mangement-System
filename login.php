			...
			<div class="card-body">
				<div class="container-fluid">
					<form method="post" action="">
						...
						<div class="d-grid">
							<button type="submit" name="login" class="btn btn-primary rounded-0">Login</button><br>
						</div>
						
					</form>
					<div class="d-grid">
							<!-- <button type="submit" name="register" class="btn btn-primary rounded-0">Register</button> -->
							<span>Dont have account? <a type="button" name="register"  href="register.php"> Register Here.</a><span>
						</div><br>

						<div class="d-grid">
							<!-- <center> -->
							<span><a type="button" name="forgot password"  href="forgot password.php">Forgot Password</span>
						<!-- </center>-->
				</div> 
			</div>
		</div>
