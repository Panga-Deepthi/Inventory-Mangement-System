...
if(!empty($_POST['btn_action']) && $_POST['btn_action'] == 'Register'){
	$inventory->registerUser();
}
if(!empty($_POST['btn_action']) && $_POST['btn_action'] == 'updatePassword'){
	$inventory->updatePassword();
}
